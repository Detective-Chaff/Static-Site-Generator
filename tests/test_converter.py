...
"""
        ...
        self.assertEqual(
            html,
            "<div><p><code>code line</code></p><p>this is paragraph text</p></div>",
        )        
...
"""
        ...
        self.assertEqual(
            html,
            "<div><p>Here's what <code>elflang</code> looks like (the perfect coding language):</p><pre><code>func main(){fmt.Println(\"Hello, World!\")}</code></pre></div>",
        )
